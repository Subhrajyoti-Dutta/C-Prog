...
double t_test(double arr1[], int len1, double mu1, double arr2[], int len2, double mu2) {
...
int main() {
    double nums1[1000], nums2[1000], mu1, mu2, con90, con95, con99, t_val;
    int noe1, noe2;
    printf("Enter the pop mean for first group: ");
    scanf("%lf", &mu1);
    ...
    scanf("%lf", &con99);
    t_val = t_test(nums1, noe1, mu1, nums2, noe2, mu2);
...
/*
Output:
    Enter the pop mean for first group: 30
    ...
    The value of t-test at 25 dof is 127.548143
